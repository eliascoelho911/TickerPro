package com.eliascoelho911.tickerpro.core.arch.viewmodel.compose
...
@Composable
fun <ACTION: com.eliascoelho911.tickerpro.core.arch.UIAction, STATE: UIState, INTENT: UIIntent> BaseViewModel<ACTION, STATE, INTENT>.collectAction(
